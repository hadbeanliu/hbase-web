...
//		method.set
	...
	public static void main(String[] args) throws URIException, UnsupportedEncodingException, FileNotFoundException {
		...
		String result=client.post("this is test from url", "http://192.168.16.111:41414");
//		String result=client.doSend("http://master:41414", null, "get");
		String encode=new String(result.getBytes(),"utf-8");
